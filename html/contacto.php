    ...
    Direccion:
        ...
        975 23 94 43
            ...
            <article id="horario" class="caja">
                ...
                <table>
                    <tr class="fila">
                        <th class="celda">Lunes</th>
                        <td class="celda">e</td>
                    </tr>
                    <tr class="fila">
                        <th class="celda">Martes</th>
                        <td class="celda">e</td>
                    </tr>
                    <tr class="fila">
                        <th class="celda">Miercoles</th>
                        <td class="celda">e</td>
                    </tr>
                    <tr class="fila">
                        <th class="celda">Jueves</th>
                        <td class="celda">e</td>
                    </tr>
                    <tr class="fila">
                        <th class="celda">Viernes</th>
                        <td class="celda">e</td>
                    </tr>
                    <tr class="fila">
                        <th class="celda">Sabado</th>
                        <td class="celda">e</td>
                    </tr>
                    <tr class="fila">
                        <th class="celda">Domingos</th>
                        <td class="celda">e</td>
                    </tr>
                </table>
            </article>
