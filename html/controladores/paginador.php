...
$consulta = "select titulo, portada, fichero from Manual where usuarioaprueba is not null;";
$parametros = array();
...
*/
generarPaginador($filas, "mostrarManuales", array("resultadoConsulta","page","nummanuales",array("../manuales/"),array("../manuales/portadas/")), "Manuales_lista.php",$numRegistros);
