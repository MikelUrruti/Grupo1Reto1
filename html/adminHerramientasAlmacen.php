                ...
                <div class="acciones">
                    ...
                    <input type="submit" class="boton" value="Eliminar" name="Eliminar">
                        ...
                        <?php
                            ...
                            generarPaginador($resultados,"mostrarTablaConFicherosImagenes",array("resultadoConsulta",array("nombre","Nombre","Categoria","Stock","Foto","Estado","Descripcion"),"page",array(),array("foto"),array(),array("img/herramientas/"),"nummanuales"),basename($_SERVER['PHP_SELF']), 1); 
