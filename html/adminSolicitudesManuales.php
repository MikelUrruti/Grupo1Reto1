                ...
                <div class="acciones">
                    ...
                    <input type="submit" class="boton botonEliminar" value="Rechazar" name="Rechazar">
                        ...
                        <?php
                            ...
                            generarPaginador($resultados,"mostrarTablaConFicherosImagenes",array("resultadoConsulta",array("titulo","Titulo","Descripcion","Fichero","Portada","Usuario Solicitante"),"page",array("fichero"),array("portada"),array("img/manuales/"),array("img/manuales/portadas/"),"nummanuales"),basename($_SERVER['PHP_SELF']), 1); 
