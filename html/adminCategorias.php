                ...
                <div class="acciones">
                    ...
                    <input type="submit" class="boton botonCrear" value="Eliminar" name="Eliminar">
                        ...
                        if (isset($_SESSION["errorAccion"])) {
                            ...
                            generarPaginador($resultados,"mostrarTablaConFicherosImagenes",array("resultadoConsulta",array("nombre","Nombre","Foto","Descripcion"),"page",array(),array("foto"),array(),array("img/categoria/"),"nummanuales"),basename($_SERVER['PHP_SELF']), 1); 
